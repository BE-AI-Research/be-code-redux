...
var themes = map[string]Palette{
	"dark":            {Name: "dark", Desc: "BE-Code default (256-colour)", Text: "252", Accent: "39", Dim: "241", Tool: "44", Err: "203", OK: "42", Warn: "214", User: "213", Cowork: "141", StatusBG: "236", StatusFG: "250", ModalTitle: "214", Border: "240"},
	"light":           {Name: "light", Desc: "readable on light backgrounds (256-colour)", Text: "236", Light: true, Accent: "25", Dim: "244", Tool: "30", Err: "124", OK: "28", Warn: "130", User: "90", Cowork: "91", StatusBG: "252", StatusFG: "236", ModalTitle: "130", Border: "248"},
	"mono":            {Name: "mono", Desc: "no colour, bold and reverse only", Mono: true, SquareBorder: true},
	"dracula":         {Name: "dracula", Desc: "purple and pink on charcoal", Text: "#f8f8f2", Accent: "#bd93f9", Dim: "#6272a4", Tool: "#8be9fd", Err: "#ff5555", OK: "#50fa7b", Warn: "#f1fa8c", User: "#ff79c6", Cowork: "#ffb86c", StatusBG: "#44475a", StatusFG: "#f8f8f2", ModalTitle: "#ffb86c", Border: "#6272a4", BG: "#282a36"},
	"nord":            {Name: "nord", Desc: "cool arctic blues", Text: "#d8dee9", Accent: "#88c0d0", Dim: "#4c566a", Tool: "#81a1c1", Err: "#bf616a", OK: "#a3be8c", Warn: "#ebcb8b", User: "#b48ead", Cowork: "#d08770", StatusBG: "#3b4252", StatusFG: "#e5e9f0", ModalTitle: "#ebcb8b", Border: "#4c566a", BG: "#2e3440"},
	"gruvbox":         {Name: "gruvbox", Desc: "warm retro earth tones", Text: "#ebdbb2", Accent: "#83a598", Dim: "#928374", Tool: "#8ec07c", Err: "#fb4934", OK: "#b8bb26", Warn: "#fabd2f", User: "#d3869b", Cowork: "#fe8019", StatusBG: "#3c3836", StatusFG: "#ebdbb2", ModalTitle: "#fe8019", Border: "#665c54", BG: "#282828"},
	"monokai":         {Name: "monokai", Desc: "classic editor greens and pinks", Text: "#f8f8f2", Accent: "#66d9ef", Dim: "#75715e", Tool: "#a6e22e", Err: "#f92672", OK: "#a6e22e", Warn: "#e6db74", User: "#ae81ff", Cowork: "#fd971f", StatusBG: "#3e3d32", StatusFG: "#f8f8f2", ModalTitle: "#fd971f", Border: "#75715e", BG: "#272822"},
	"one-dark":        {Name: "one-dark", Desc: "Atom One Dark", Text: "#abb2bf", Accent: "#61afef", Dim: "#5c6370", Tool: "#56b6c2", Err: "#e06c75", OK: "#98c379", Warn: "#e5c07b", User: "#c678dd", Cowork: "#d19a66", StatusBG: "#3e4451", StatusFG: "#abb2bf", ModalTitle: "#d19a66", Border: "#5c6370", BG: "#282c34"},
	"solarized-dark":  {Name: "solarized-dark", Desc: "Solarized on base03", Text: "#839496", Accent: "#268bd2", Dim: "#586e75", Tool: "#2aa198", Err: "#dc322f", OK: "#859900", Warn: "#b58900", User: "#d33682", Cowork: "#cb4b16", StatusBG: "#073642", StatusFG: "#93a1a1", ModalTitle: "#cb4b16", Border: "#586e75", BG: "#002b36"},
	"solarized-light": {Name: "solarized-light", Desc: "Solarized on base3", Text: "#657b83", Light: true, Accent: "#268bd2", Dim: "#93a1a1", Tool: "#2aa198", Err: "#dc322f", OK: "#859900", Warn: "#b58900", User: "#d33682", Cowork: "#cb4b16", StatusBG: "#eee8d5", StatusFG: "#586e75", ModalTitle: "#cb4b16", Border: "#93a1a1", BG: "#fdf6e3", FG: "#657b83"},
...
func newStyles(name string) (styles, bool) {
	...
	if p.Mono {
		...
		// No colour to give the co-worker, so it takes the same emphasis the
