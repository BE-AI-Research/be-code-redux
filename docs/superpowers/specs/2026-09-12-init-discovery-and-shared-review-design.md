...
for validation. The scan is bounded: at most 20,000 files visited, 2 s of
walking; beyond that the sheet says it was truncated.
...
3. On violations: one retry with the violations appended ("The previous
   ...
   written as BECODE.md under a first line
...
prints the document and asks `write BECODE.md? [y/N]`.
